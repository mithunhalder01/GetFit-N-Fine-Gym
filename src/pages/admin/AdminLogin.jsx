    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          <div className="font-black text-3xl tracking-widest text-orange-500 mb-2" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
            {GYM.name}
          </div>
        ...
        <div className="bg-gray-900 border border-white/10 rounded-2xl p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button type="submit" disabled={loading}
              className="w-full bg-orange-500 text-black font-black uppercase text-sm tracking-widest py-3.5 rounded-xl hover:bg-orange-600 transition-all disabled:opacity-50">
