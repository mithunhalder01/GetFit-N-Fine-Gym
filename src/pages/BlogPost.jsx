      ...
      <section className="bg-black py-16 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <FadeIn>
            ...
            <div className="mt-8 bg-[#0a0a0a] border border-white/5 rounded-3xl p-5 sm:p-8 md:p-10">
              ...
              <h1 className="mt-3 text-2xl sm:text-3xl md:text-4xl font-black text-white" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                {post.title}
              </h1>
              ...
              <div className="mt-8 p-5 rounded-2xl bg-white/5 border border-white/10">
                ...
                <div className="mt-4 flex flex-col sm:flex-row gap-3">
                  <Link to="/contact" className="w-full sm:w-auto text-center bg-yellow-400 text-black font-black uppercase text-xs tracking-widest px-6 py-3 rounded-lg hover:bg-yellow-300 transition-colors">
                    Book Free Trial
                  </Link>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-full sm:w-auto text-center border border-white/15 text-white/70 font-black uppercase text-xs tracking-widest px-6 py-3 rounded-lg hover:border-yellow-400 hover:text-yellow-400 transition-colors"
                  >
                    WhatsApp Us
                  </a>
                </div>
